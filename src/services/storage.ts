...
export const DEFAULT_HABITS: Habit[] = [
  ...
  },
  {
    id: 'habit-5',
    name: 'Read 2 Books',
    description: 'Non-fiction or personal development books',
    icon: '📚',
    rewardValue: 20,
    maxPerPeriod: 2,
    maxPerDay: 1,
...
export const loadStoredHabits = (): Habit[] => {
  try {
    ...
    return habits.map(h => ({
      ...
      maxPerPeriod: h.maxPerPeriod !== undefined ? h.maxPerPeriod : (h.maxPerDay !== undefined ? h.maxPerDay : 1),
      maxPerDay: h.maxPerDay !== undefined ? h.maxPerDay : 1,
      isQuickHabit: Boolean(h.isQuickHabit),
      category: h.category || 'Personal',
      tags: Array.isArray(h.tags) ? h.tags : [h.category || 'Personal']
    }));
  } catch (e) {
